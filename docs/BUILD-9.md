...
Precision persistence and the main-screen/logging UI tests passed (2 tests, 0 failures) on iOS 26.2 Pro Max. Reviewed and shown to the user: [actual Home screenshot with synthetic data](screenshots/build9-home.png). Release archive succeeded. Model parameters and saved user data are unchanged.

Builds 7 and 8 were uploaded but never distributed; build 9 supersedes both.
